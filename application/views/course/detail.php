...
<div class="cf">
    ...
    <?php if(isset($user)): ?>
        <button id="add_to_plan" class="fr" onclick="course.addToPlan(<?php echo $user['id'], ',', $course->id ?>)" <?php if(isset($hasCourseInPlan) AND $hasCourseInPlan) {echo 'disabled';}?> >Add to Plan</button>
    <?php endif ?>
