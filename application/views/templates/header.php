...
<div id="MAIN_CONTAINER">
    ...
    <?php if(isset($user)): ?>
        <div id="DASHBOARD_LINKS">
            <ul class="cf">
                <li class="fl <?php if($selectedNav === 'overview')echo 'selected'?>"><a href=<?php echo base_url('index.php/dashboard')?>>Dashboard</a></li> 
                <li class="fl <?php if($selectedNav === 'my_plan')echo 'selected'?>"><a href=<?php echo base_url('index.php/dashboard/my_plan')?>>My Plan</a></li>  
                <li class="fl <?php if($selectedNav === 'browse')echo 'selected'?>"><a href=<?php echo base_url('index.php/dashboard/browse')?>>Browse Courses</a></li>  
                <li class="fl <?php if($selectedNav === 'help')echo 'selected'?>"><a href=<?php echo base_url('index.php/dashboard/help')?>>Help</a></li> 
            </ul>
        </div>
    <?php endif; ?>
