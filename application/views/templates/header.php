...
<div id="MAIN_CONTAINER">
    ...
    <?php if(isset($user)): ?>
        <div id="DASHBOARD_LINKS">
            <ul class="cf">
                <li class="fl"><a <?php if($selectedNav === 'overview')echo 'class="selected"'?> href=<?php echo base_url('index.php/dashboard')?>>Dashboard</a></li> 
                <li class="fl"><a <?php if($selectedNav === 'my_plan')echo 'class="selected"'?> href=<?php echo base_url('index.php/dashboard/my_plan')?>>My Plan</a></li>  
                <li class="fl browse"><a <?php if($selectedNav === 'browse')echo 'class="selected"'?> href=<?php echo base_url('index.php/dashboard/browse')?>>Browse Courses</a></li>  
                <li class="fl"><a <?php if($selectedNav === 'help')echo 'class="selected"'?> href=<?php echo base_url('index.php/dashboard/help')?>>Help</a></li> 
            </ul>
        </div>
    <?php endif; ?>
