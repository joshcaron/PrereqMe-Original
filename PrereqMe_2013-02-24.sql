...
INSERT INTO `pm_course` (`id`, `deptId`, `title`, `code`, `credits`, `description`, `new`)
VALUES
	...
	(2,1,'Computer Science/Information Science Overview 1',1200,1,'Introduces students to the College of Computer and Information Science (CCIS) and begins their preparation for careers in the computing and information fields. Offers students an opportunity to learn how to thrive at Northeastern and within CCIS by developing academic, professional, and interpersonal skills. Covers the variety of careers available in the high-technology professions. Students work in groups to create and deliver presentations on careers in the field.',0),
	(3,1,'Computer Science/Information Science Overview 2: Co-op Preparation',1210,1,'Continues the preparation of students for careers in the computing and information fields by discussing co-op and co-op processes. Offers students an opportunity to prepare a professional r?sum?; practice proper interviewing techniques; explore current job opportunities; learn how to engage in the job and referral process; and to understand co-op policies, procedures, and expectations. Discusses professional behavior and ethical issues in the workplace.',0),
	(4,1,'Computer/Information Science Co-op Preparation',1220,1,'Prepares students for co-op through topics such as ethics, privacy, security, responsibility, and intellectual property. Exposes students to popular industry technologies. ? Prerequisite: Intended for transfer students into computer/information science who are above the freshman level.',0),
	(5,1,'Algorithms and Data Structures for Engineering',1500,4,'Introduces algorithms and data structures for engineering students. Discusses data structures such as arrays, stacks, queues, and lists, and the algorithms that manipulate these structures. Introduces simple algorithm analysis. Discusses classes and objects and presents the basic material about encapsulation, inheritance, and polymorphism. Introduces software development practices such as modular design, use of libraries, testing methods, and debugging techniques.',0),
	(6,1,'Lab for CS 1500',1501,1,'Accompanies CS 1500. Covers topics from the course through various experiments. ? Prerequisite: Not open to students in the College of Computer and Information Science.',0),
	...
	(63,1,'Mobile Application Development',5520,4,'Focuses on mobile application development on a mobile phone or related platform. Discusses memory management; user interface building, including both MVC principles and specific tools; touch events; data handling, including core data, SQL, XML, and JSON; network techniques and URL loading; and, finally, specifics such as GPS and motion sensing that may be dependent on the particular mobile platform. Students are expected to work on a project that produces a professional-quality mobile application and to dem',0),
	...
	(79,1,'Empirical Research Methods',6350,4,'Presents an overview of methods for conducting empirical research within computer science. These methods help provide objective answers to questions about the usability, effectiveness, and acceptability of systems. The course covers the basics of the scientific method, building from a survey of objective measures to the fundamentals of hypothesis testing using relatively simple research designs, and on to more advanced research designs and statistical methods. The course also includes a significant amount o',0),
	(80,1,'Compilers',6410,4,'Expects each student to write a small compiler. Topics include parser generation, abstract syntax trees, symbol tables, type checking, generation of intermediate code, simple code improvement, register allocation, run-time structures, and code generation. ',0),
	(81,1,'Semantics of Programming Language',6412,4,'Studies mathematical models for the behavior of programming languages. Topics include operational, denotational, and equational specifications; Lambda-calculi and their properties; applications of these techniques, such as rapid prototyping and correctness of program optimizations.',0),
	(82,1,'Advanced Software Development',6510,4,'Presents current ideas and techniques in software methodology and provides a means for students to apply these techniques. Students are expected to design, implement, test, and document a software project.',0),
